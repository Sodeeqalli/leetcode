...
#Thought process
#second simplest leetcode question
#simply iterate over the candies
#add extra candies and check if it is equal to or more than the greatest number of candies
#if true, append true to result else append false
